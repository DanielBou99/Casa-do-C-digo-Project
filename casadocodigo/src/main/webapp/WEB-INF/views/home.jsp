				...
				<nav id="main-nav">
					<ul class="clearfix">
						<security:authorize access="hasRole('ROLE_ADMIN')"> 
							...
							<li><a href="${s:mvcUrl('PC#form').build()}" rel="nofollow">Cadatro de Produto</a></li>
						</security:authorize>			
		...
		<ul class="clearfix book-collection">
			...
			<c:forEach items="${produtos}" var="produto">
				<li>
					...
					src="https://cdn.shopify.com/s/files/1/0155/7645/products/java8-featured_large.png?v=1411490181" alt="Java 8 Prático" title="Java 8 Prático" /> 
